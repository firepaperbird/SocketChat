...
import socketchat.ClientChatter;
import socketchat.ManagerChatter;
...
public class Wellcome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Wellcome to Quan's Chat");
    ...
    private void btnServerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnServerActionPerformed
        if(s==null){
            s = new ManagerChatter();
            s.setVisible(true);
            dispose();
        }else{
            JOptionPane.showMessageDialog(this, "Server are aready on");
        }
